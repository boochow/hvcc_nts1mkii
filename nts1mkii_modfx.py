...
def render_from_template(template_file, rendered_file, context):
    ...
    fx_templates_dir = os.path.join(os.path.dirname(__file__), "mod", "templates")
    ...
    def compile(
        ...
        try:
            ...
            if num_output_channels != 2:
                raise Exception("Mod units support only stereo output.")
            ...
            fx_static_dir = os.path.join(os.path.dirname(__file__), "mod", "static")
